            ...
            <div class="container-fluid">
                ...
                <div class="container-xxl position-relative p-0">
                    ...
                    <div class="container-xxl py-5 bg-red hero-header mb-5">
                        ...
                        <?php include_once 'C:/xamppp/htdocs/EphoriaFest1/controller/logementController.php';
						$rec=new logementController();
						$result=$rec->recupererLog($_GET['IDclient']); ?>

                                <?php foreach ($result as $row) { ?>
                            
                        <form name="formulaire"  action="modifierlog.php" method='POST'>
                            <label for="IDclient">IDclient:
                            </label>
                            <input type="IDclient" id="IDclient" name="IDclient" value="<?php echo $_GET["IDclient"];?>"
                             minlength="5" maxlength="8" size="10">
                            <br><br>
                            <label for="Nom">Nom:
                            </label>
                            ...
                            <input type="rooms" id="rooms" name="rooms" value="<?php echo $row["rooms"];?>"
                            minlength="1" maxlength="2" size="10">
                            <br><br>

                            <label for="adults">adults:
                            </label>
                            <input type="adults" id="adults" name="adults" value="<?php echo $row["adults"];?>"
                            minlength="1" maxlength="2" size="10">
                            <br><br>
                        ...
                        <?php } ?>
                        <button>
                            <a href="afficherListeLog.php">Listes des LOGEMENTS</a>
                        </button>
