        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="log-trans.html">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="container-xxl position-relative p-0">
                    ...
                    <div class="container-xxl py-5 bg-red hero-header mb-5">
                        ...
                        <?php
                        include_once '/xamppp/htdocs/EphoriaFest1/controller/logementController.php';
                        $log = new logementController();
                        $loge = $log->afficherLog();
                        ?>

                        <button>
                            <a href="logement.php">Ajouter des LOGEMENTS</a>
                        </button> 
                        <center>
                            <h1>Liste des Reservation</h1>
                        </center>
                        <table border="1" bordercolor="white" align="center" style="color:block;">
                            <tr>
                                <th>Id</th>
                                <th>nom</th>
                            ...
                            ?>
                                <tr>
                                 ...
                                 <td><?php echo $row['adults']; ?></td>
                                   ...
                                   <td>
                                   <a href="modifierLog.php?IDclient=<?php echo $row['IDclient']; ?>">modifier</a>
                                    </td>
                                    
                                    <td>
                                        <a href="supprimerLog.php?IDclient=<?php echo $row['IDclient']; ?>">Supprimer</a>
                                    </td>
                                </tr>
                            <?php
                            }
